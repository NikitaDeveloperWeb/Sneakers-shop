...
?>
        <div class="cart">
          ...
          <div class="cart-result">
            ...
            <form action="">
              <input type="text" class="input-field" placeholder="Ваш город">
              <input type="text" class="input-field" placeholder="Ваш адрес">
              <input type="text" class="input-field" placeholder="Ваш номер дома">
              <input type="text" class="input-field" placeholder="Ваша квартира">
